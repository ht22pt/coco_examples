...
function initialize_anncats()
{
  ...
  for (i = 0; i < im_urls.length; i++) {
    ...
    im[i].children().load(function () {
      ...
      button_panel_right.hover(function () {
          $(this).find('img').attr('src', "static/img/icons/right_green.png")
        },
        function () {
      ...
      button_panel_left.hover(function () {
          $(this).find('img').attr('src', "static/img/icons/left_green.png")
        },
        function () {
          $(this).find('img').attr('src', "static/img/icons/left.png")
        });
